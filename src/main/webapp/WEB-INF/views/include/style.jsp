...
<link rel="stylesheet" type="text/css" href="${ctxStatic }/bootstrap/css/bootstrap-responsive.min.css"/>
<link rel="stylesheet" href="${ctxStatic }/jquery-ztree/3.5.12/css/zTreeStyle/zTreeStyle.min.css" type="text/css">
<link rel="stylesheet" type="text/css" href="${ctxStatic }/sys/css/sys.css"/>
...
<script type="text/javascript" src="${ctxStatic }/sha/js/sha.js"></script>
<script type="text/javascript" src="${ctxStatic }/jquery-select2/3.4/select2.min.js"></script>
<script type="text/javascript" src="${ctxStatic }/My97DatePicker/WdatePicker.js"></script>
<script type="text/javascript" src="${ctxStatic }/sys/js/sys.js"></script>
<script type="text/javascript" src="${ctxStatic }/layer/layer.js"></script>
<%-- <input id="sys-ctx" type="hidden" value="${ctx }"/> --%>

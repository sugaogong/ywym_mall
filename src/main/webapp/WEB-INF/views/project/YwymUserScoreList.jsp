...
<head>
    ...
    <title>用户个人积分明细</title>
    <%@ include file="/WEB-INF/views/include/style.jsp"%>
</head>
<body>
<form:form id="searchForm" modelAttribute="ywymLogUser" action="/sys/ywymLogUserWebController/gotUserScoreList" method="post" class="breadcrumb form-search">
    <li><label>变更时间：</label>
